...
method = 'PUT'
service = 'es'
host = 'search-search1090-4xbqf6kj65zzwsuhpihvobjmom.us-east-1.es.amazonaws.com'
region = 'us-east-1'
...
amz_target = ''
cannUrl = '/search1090index3'

endpoint = 'https://' + host + cannUrl


# Request parameters for CreateTable--passed in a JSON block.
#request_parameters =  '{'
#request_parameters +=  '"transient": {"http.cors.allow-headers": "Authentication, X-Requested-With, Content-Type, Content-Length"}'
#request_parameters +=  '}'
#2016-09-01 17:18:00.171
